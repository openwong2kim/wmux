 ...
 * UNSET exercises the per-receiver default. clientName 'wmux-cli' → the
 * curated internal-CLI lane (#1111 closes the envelope-less grandfather in the
 * first release on or after 2026-09-30).
 *
...
// OUTSIDE that allowlist (a2a.task.send / a2a.task.update / mcp.claimWorkspace / input.readScreen)
...
const DOGFOOD_CAPABILITIES = ["a2a.send", "a2a.read", "workspace.claim", "terminal.read", "terminal.send"];
