export const tr = {
  ...
  'settings.tabKeyboard': "Klavye",
  'settings.tabClaudeCode': "Claude Code",
  'settings.tabOrchestrator': "Orkestratör",
  'settings.tabRoles': "Roller ve fan-out",
  'settings.tabRemote': "Uzak ve telefon",
  'settings.tabLan': "LAN",
  'settings.navGroupConnections': "Bağlantılar",
  'settings.learnMore': "Daha fazla bilgi",
  'settings.showLess': "Daha az göster",
  'settings.quickCommands': "Hızlı komutlar",
  'settings.sectionShell': "Kabuk",
  'settings.sectionInput': "Giriş",
  'settings.sectionPerformance': "Çizim ve bellek",
  'settings.sectionScrollback': "Kaydırma geçmişi",
  'settings.sectionInterface': "Arayüz",
  'settings.sectionSidebar': "Kenar çubuğu",
  'settings.sectionPanes': "Bölmeler",
  'settings.quickCommandsDesc': "Bu Mac ile eşleşen telefonlarla paylaşılır. Talimatları kopyalayın veya ekleyin, göndermeden önce gözden geçirin.",
  'settings.quickCommandsRefresh': "Yenile",
  'settings.quickCommandsCopy': "Kopyala",
  'settings.quickCommandsCopied': "Kopyalandı",
  'settings.quickCommandsEdit': "Düzenle",
  'settings.quickCommandsDelete': "Sil",
  'settings.quickCommandsTitlePlaceholder': "Başlık",
  'settings.quickCommandsTextPlaceholder': "Yeniden kullanılabilir talimatlar",
  'settings.quickCommandsAdd': "Komut ekle",
  'settings.quickCommandsSave': "Değişiklikleri kaydet",
  'settings.quickCommandsCancelEdit': "Düzenlemeyi iptal et",
  'settings.quickCommandsReadError': "Hızlı komutlar okunamadı.",
  'settings.quickCommandsSaveConflict': "Liste başka bir yerde değişmiş olabilir. Yeniden kaydetmeden önce yenileyip gözden geçirin. Düzenleyicideki metniniz korunur.",
  'settings.quickCommandsCopyError': "Komut kopyalanamadı.",
  'settings.quickCommandsTitleLabel': "Hızlı komut başlığı",
  'settings.quickCommandsTextLabel': "Hızlı komut talimatları",
  ...
  'settings.chromePreset': 'Arayüz görünürlüğü',
  'settings.chromePresetDesc': 'Tek seferlik bir düzen ön ayarı uygular. Ayrı görünürlük denetimleri düzenlenebilir kalır; herhangi bir mod kaydedilmez.',
  'settings.chromePresetMinimal': 'Minimal\'i Uygula',
  'settings.chromePresetStandard': 'Standardı Geri Yükle',
  'settings.chromePresetApplied': 'Arayüz görünürlüğü güncellendi.',
  ...
  'settings.updateEndsSessions': 'Kurulum tüm bölmeleri kapatır.',
  'settings.currentVersion': 'Geçerli',
  'settings.latestVersion': 'En son',
  'update.readyToInstall': 'wmux {version} kuruluma hazır. Şu anda {current} sürümünü kullanıyorsunuz. Kurulum tüm bölmeleri kapatır.',
  'update.installNow': 'Şimdi kur',
  'update.installFailed': 'Güncelleme kurulamadı. {error}',
