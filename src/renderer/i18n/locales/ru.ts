export const ru = {
  ...
  'settings.sidebarAttentionFirstDesc': 'Закреплять вверху боковой панели рабочие пространства, агент которых ждёт вашего ответа. По умолчанию выключено: строки остаются там, куда вы их перетащили.',
