export const ko = {
  'chat.closeManaged': '별도 챗 닫기',
  'chat.reviewChanges': '변경 검토',
  'chat.activity': '작업 과정',
  'chat.managedSession': "챗 세션 · 터미널과 별도",
  'chat.stop': "중단",
  'chat.reconnect': "재연결 후 기록 확인",
  'chat.deliveryUnknown': "마지막 요청이 전달되었을 수 있습니다. 재연결 후 대화를 확인하고 다음 메시지를 보내세요. 자동으로 재전송하지 않습니다.",
  'chat.retentionLimit': "오래된 출력이 로컬 표시 한도를 넘었습니다. 에이전트 자체 세션 기록은 유지됩니다.",
  'chat.startHint': "이 작업 폴더에서 별도 챗 세션을 시작합니다. 실행 중인 터미널 에이전트를 전환하는 기능은 아닙니다.",
  'chat.provider': "챗 에이전트",
  'chat.chooseAgentHint': '아래에서 에이전트와 실행 모드를 선택하고 메시지를 보내세요.',
  'chat.launchMode': '실행 모드',
  'chat.modeDefault': '기본 모드',
  'chat.modeBypass': 'Bypass 모드',
  'chat.modeYolo': 'YOLO 모드',
  'chat.initialMessage': '첫 메시지를 입력하세요',
  'chat.terminalStartHint': '같은 터미널에서 에이전트를 시작합니다. 셸에 입력 중인 명령이 없어야 합니다.',
  'chat.terminalStarting': '터미널에서 시작했습니다. 대화가 생성되면 자동으로 연결됩니다. 로그인이나 신뢰 확인은 터미널에서 완료하세요.',
  'chat.startNew': "새 챗 시작",
  'chat.controlFailed': "챗 작업 결과를 확인할 수 없습니다.",
  'chat.customAnswer': "답변 입력",
  'chat.submitAnswer': "답변 제출",
  // Per-session transcript chat
  'chat.state.connecting': '연결 확인 중…',
  'chat.state.disconnected': '업데이트 연결 끊김 · 완료 여부 확인 불가',
  'chat.state.unavailable': '대화를 불러올 수 없음',
  'chat.state.ended': '에이전트 세션 종료 · 저장된 기록',
  'chat.state.sending': '전송 중…',
  'chat.state.blocked': '입력 또는 승인 확인 대기',
  'chat.state.working': '응답 진행 중',
  'chat.state.waiting': '전송됨 · 응답 대기',
  'chat.state.complete': '응답 완료',
  'chat.state.ready': '대기 중',
  'chat.state.unconfirmed': '응답 완료 여부 미확인',
  'chat.send.unconfirmed': '터미널에서 복원된 입력을 확인하고 다음 응답을 완료한 뒤 챗에서 이어가세요. 두 요청이 합쳐지는 것을 막기 위해 전송을 잠시 중지했어요.',
  'chat.recordedUpdates': 'Claude가 기록할 때 메시지가 표시됩니다. 잠시 조용할 수 있습니다.',
  'chat.checkingConnection': '대화 업데이트 연결 확인 중…',
  'chat.lastSynced': '{seconds}초 전 동기화',
  'chat.viewMode': "세션 보기",
  'chat.terminal': "터미널",
  'chat.chat': "대화",
  'chat.conversation': "대화 기록",
  'chat.loading': "대화를 불러오는 중…",
  'chat.loadEarlier': "이전 메시지 불러오기",
  'chat.unavailable': "아직 읽을 수 있는 대화 기록이 없습니다",
  'chat.reason.no-hook': "wmux 연동을 활성화한 에이전트를 이 터미널에서 실행하면 같은 대화를 볼 수 있습니다.",
  'chat.reason.stale-session': "터미널의 대화가 아직 연결되지 않았습니다. 터미널에서 계속 작업하면 자동으로 다시 확인합니다.",
  'chat.reason.no-transcript-path': "에이전트의 대화 기록을 기다리고 있습니다.",
  'chat.reason.not-claude': "이 터미널 세션의 대화 기록 연동은 아직 지원되지 않습니다. 아래에서 별도 챗 세션을 시작할 수 있습니다.",
  'chat.reason.unsafe-transcript-path': "대화 기록 파일을 확인할 수 없습니다. 터미널에서 계속 작업해 주세요.",
  'chat.reason.unreadable': "대화 기록 파일을 읽을 수 없습니다. 터미널은 계속 사용할 수 있습니다.",
  'chat.reason.unavailable': "대화 기록에 연결할 수 없습니다. 터미널로 전환하거나 잠시 후 다시 시도해 주세요.",
  'chat.openTerminal': "터미널로 전환",
  'chat.scrollToBottom': '최신 메시지로 이동',
  'chat.empty': "다음 메시지를 기다립니다",
  'chat.emptyHint': "이 세션의 메시지가 여기에 표시됩니다.",
  'chat.working': "에이전트가 작업 중입니다…",
  'chat.connectionError': "대화 기록 갱신이 중단되었습니다.",
  'chat.retry': "다시 시도",
  'chat.approvalHint': "승인 요청 또는 세션 상태를 확인하는 동안 전송이 잠깁니다. 터미널에서 요청을 확인해 주세요.",
  'chat.message': "이 세션에 보낼 메시지",
  'chat.placeholder': "이 세션에 메시지 보내기…",
  'chat.placeholderEnded': "세션이 종료되었습니다. 이어가려면 터미널에서 재개하세요.",
  'chat.commandsAndSkills': "명령어 · 스킬",
  'chat.inChat': "챗에서 열기",
  'chat.inTerminal': "터미널에서 사용",
  'chat.bridgeOutdated': "이 창의 앱 연결 코드가 이전 버전입니다. 터미널 세션은 유지하고 앱을 다시 열어 주세요.",
  'chat.modelTitle': "모델 · 추론 강도",
  'chat.modelLabel': "모델",
  'chat.effortLabel': "추론 강도",
  'chat.applyModel': "이 세션에 적용",
  'chat.closeMenu': "닫기",
  'chat.modelError.unavailable': "이 세션의 모델 설정을 읽지 못했습니다. 다시 시도하거나 터미널에서 확인하세요.",
  'chat.modelError.busy': "현재 응답이 끝난 후 모델을 변경할 수 있습니다.",
  'chat.modelError.stale': "세션이 변경됐습니다. 현재 설정을 다시 불러온 후 적용하세요.",
  'chat.modelError.unconfirmed': "변경 결과를 확인하지 못했습니다. 먼저 현재 설정을 다시 불러오세요.",
  'chat.modelError.unsupported-choice': "사용할 수 없는 모델·추론 강도입니다. 목록을 다시 불러오세요.",
  'chat.command.model': "모델과 추론 강도 선택",
  'chat.command.fast': "네이티브 에이전트에서 빠른 모드 설정",
  'chat.command.ide': "터미널에서 IDE 컨텍스트 설정",
  'chat.command.permissions': "에이전트의 실행 권한 확인·설정",
  'chat.command.keymap': "터미널 단축키 설정",
  'chat.command.vim': "네이티브 Vim 입력 모드 설정",
  'chat.command.experimental': "터미널에서 실험 기능 확인",
  'chat.command.approve': "네이티브 승인 화면에서 거절된 작업 확인",
  'chat.command.context': "터미널에서 컨텍스트 확인",
  'chat.command.compact': "터미널에서 대화 압축 설정",
  'chat.command.help': "네이티브 명령 인터페이스 열기",
  'chat.skills': "스킬",
  'chat.skillsHint': "선택 후 요청을 덧붙여 전송하세요.",
  'chat.skillsCodexHint': "Codex 스킬은 $이름으로 입력됩니다.",
  'chat.skillsUnavailable': "스킬 목록을 불러오지 못했습니다. 터미널에서 에이전트 상태를 확인하세요.",
  'chat.skillsPartial': "일부 스킬을 표시하지 못했습니다. 전체 목록은 터미널에서 확인하세요.",
  'chat.skillsNoMatch': "일치하는 스킬이 없습니다.",
  'chat.skillsEmpty': "이 프로젝트·계정에서 호출할 수 있는 스킬을 찾지 못했습니다.",
  'chat.skillsKeys': "↑↓ 이동 · Enter / Tab 선택 · Esc 닫기",
  'chat.skillSource.project': "프로젝트",
  'chat.skillSource.user': "개인",
  'chat.skillSource.plugin': "플러그인",
  'chat.skillSource.system': "시스템",
  'chat.inputHint': "Enter 전송 · Shift+Enter 줄바꿈",
  'chat.inputSkillsHint': "/ 명령·스킬 · Enter 전송 · Shift+Enter 줄바꿈",
  'chat.send': "보내기",
  'chat.sendUnavailable': "지금은 이 세션에 메시지를 보낼 수 없습니다.",
  'chat.send.sent': "세션으로 전송했습니다. Claude가 기록하면 대화에 표시됩니다.",
  'chat.send.busy': "세션이 작업 중입니다. 작업이 끝난 후 전송해 주세요.",
  'chat.send.blocked': "터미널에서 응답을 기다리는 프롬프트가 있습니다. 터미널에서 처리한 후 전송해 주세요.",
  ...
  'chat.code': "코드",
  'chat.lines': "줄",
  'chat.truncated': "큰 내용은 표시 범위가 제한될 수 있습니다.",
  'chat.you': "나",
  'chat.thinking': "생각 과정",
  'chat.imageInTerminal': "이미지 첨부 — 터미널에서 확인해 주세요.",
  'chat.state.stopped': "중단됨",
  'chat.stopping': "중단하는 중…",
  'chat.stopTitle': "진행 중인 응답 중단 (Esc)",
  'chat.stopState.stopping': "중단하는 중…",
  'chat.stopState.stopped': "중단했습니다.",
  'chat.stopState.kept': "에이전트가 계속 실행 중입니다.",
  'chat.stopState.not_running': "중단할 응답이 없습니다 — 이미 끝났습니다.",
  'chat.stopState.blocked': "터미널의 프롬프트가 키 입력을 받고 있습니다. 터미널에서 중단하거나 답해 주세요.",
  'chat.stopState.failed': "챗에서 중단하지 못했습니다.",
  'chat.hint.runningQueue': "Esc·중단으로 멈춤 · Enter는 메시지를 대기열에 추가",
  'chat.hint.runningStop': "Esc·중단으로 멈춤 · 응답이 끝난 뒤 전송",
  'chat.hint.runningNoStop': "이 에이전트는 챗에서 중단할 수 없습니다 — 터미널에서 중단하세요",
  'chat.queued': "대기 중 · 현재 응답이 끝나면 실행",
  'chat.pendingSent': "전송됨",
  'chat.attachments': "첨부",
  'chat.attach.remove': "{name} 제거",
  'chat.attach.type': "{name}은(는) 이 에이전트가 받을 수 있는 이미지가 아닙니다 (PNG·JPEG·GIF·WebP).",
  'chat.attach.size': "{name}이(가) 10MB보다 큽니다.",
  'chat.attach.missing': "{name}을(를) 읽지 못했습니다.",
  'chat.attach.limit': "메시지당 이미지는 {count}개까지입니다.",
  'chat.attach.unsupported': "이 에이전트는 챗으로 이미지를 받을 수 없습니다. 터미널에 놓아 주세요.",
  'chat.attach.pasteFailed': "클립보드 이미지를 읽지 못했습니다.",
  'chat.openImage': "{name} 열기",
  'chat.diff': "변경 내용 보기",
  'chat.toolInput': "입력",
  'chat.toolResult': "결과",
  'chat.toolDone': "완료",
  'chat.toolError': "실패",
  'chat.toolPending': "결과 대기",
  ...
  'sidebar.pin': '위치 고정',
  'sidebar.unpin': '위치 고정 해제',
  'sidebar.provenance.by': '{owner}에서 분배함',
  'sidebar.provenance.callerGui': '나 (GUI)',
  'sidebar.provenance.callerOrchestrator': '오케스트레이터',
  'sidebar.provenance.callerPane': '에이전트 페인',
  'sidebar.provenance.closedOwner': '닫힌 워크스페이스',
  'sidebar.tasks.count': '태스크 {count}개',
  'sidebar.tasks.countOne': '태스크 1개',
  'sidebar.tasks.expand': '분배된 태스크 보기',
  'sidebar.tasks.collapse': '분배된 태스크 숨기기',
  'sidebar.tasks.menu': '태스크 그룹 작업',
  ...
  'sidebar.tasks.skipGone': '남김 — 이미 닫혔습니다',
  'sidebar.tasks.skipDetached': '남김 — 분리되었습니다',
  'sidebar.tasks.skipMoved': '남김 — 더 이상 이 그룹 소속이 아닙니다',
  'sidebar.tasks.skipNotFinished': '남김 — 에이전트가 다시 작업 중입니다',
  'sidebar.tasks.groupLabel': '{owner}의 분배 태스크',
  'sidebar.tasks.orphanGroup': '닫힌 워크스페이스에서',
  'sidebar.tasks.backToOwner': '이 태스크를 분배한 워크스페이스 {owner}(으)로 돌아가기',
  'sidebar.tasks.toReview': '리뷰 대기 {count}',
  'sidebar.tasks.toReviewLabel': '리뷰를 기다리는 완료 태스크 {count}개를 Fleet에서 보기',
  'sidebar.resize': '사이드바 너비 조절 (더블클릭으로 초기화)',
  ...
  'fleet.overview': '패널 {count}개 · 실행 중 {running}개',
  'fleet.scope': '워크스페이스 {projects}개 · 페인 {count}개',
  'fleet.filter.all': '전체',
  'fleet.filter.attention': '확인 필요',
  'fleet.filter.label': '상태별 페인 필터',
  'fleet.search': '작업, 프로젝트, 에이전트 검색…',
  'fleet.noMatches': '조건에 맞는 페인이 없습니다.',
  'fleet.resetFilters': '전체 페인 보기',
  'fleet.status.turnComplete': '응답 완료',
  'fleet.status.unconfirmed': '확인 불가',
  'fleet.detail.supervisionStopped': '자동 복구가 중단됐습니다. 터미널을 확인하세요.',
  'fleet.detail.unconfirmed': '30분 이상 활동 보고가 없습니다. 터미널을 확인하세요.',
  'fleet.detail.error': '오류가 보고됐습니다. 터미널을 확인하세요.',
  'fleet.detail.complete': '응답이 끝났습니다. 터미널에서 결과를 확인하세요.',
  'fleet.detail.running': '응답 진행 중',
  'fleet.detail.idle': '최근 활동 정보 없음',
  'fleet.action.respond': '응답하기',
  'fleet.action.result': '결과 보기',
  'fleet.action.inspect': '확인하기',
  'fleet.action.open': '열기',
  'fleet.stashed': '보관됨',
  'fleet.preview': '터미널 미리보기',
  'fleet.previewEmpty': '표시할 터미널 출력이 없습니다.',
  'fleet.section.needsYou': '확인 필요',
  'fleet.section.running': '실행 중',
  ...
  'fleet.verb.jump': '페인으로 이동',
  'fleet.verb.message': '메시지',
  'fleet.verb.messageUnavailable': '응답이 끝나면 사용할 수 있습니다',
  ...
  'fleet.close.cancel': '취소',
  'fleet.section.review': '리뷰 대기',
  'fleet.review.statusLabel': '완료',
  'fleet.review.files': '파일 {count}개 변경',
  'fleet.review.filesOne': '파일 1개 변경',
  'fleet.review.noChanges': '변경 없음',
  'fleet.review.prState': 'PR #{number} · {state}',
  'fleet.review.prLinked': 'PR 연결됨',
  'fleet.review.pr.open': '열림',
  'fleet.review.pr.draft': '드래프트',
  ...
  'fleet.review.closeConfirm': '이 태스크를 닫을까요? 워크트리와 워크스페이스가 삭제됩니다. 커밋·푸시 안 된 작업이 있으면 닫지 않습니다.',
  'fleet.review.prConfirm': '{branch}을(를) 푸시하고 PR을 열까요? pre-push 훅이 실행될 수 있습니다.',
  'fleet.review.closed': '{title} 닫음',
  'fleet.review.closing': '닫는 중…',
  'fleet.review.creatingPr': 'PR 만드는 중…',
  ...
  'settings.quickCommandsDesc': "이 Mac과 페어링된 휴대폰에서 함께 씁니다. 지시문을 복사하거나 넣은 뒤 보내기 전에 확인하세요.",
  'settings.quickCommandsRefresh': "새로고침",
  'settings.quickCommandsCopy': "복사",
  'settings.quickCommandsCopied': "복사됨",
  'settings.quickCommandsEdit': "편집",
  'settings.quickCommandsDelete': "삭제",
  'settings.quickCommandsTitlePlaceholder': "제목",
  'settings.quickCommandsTextPlaceholder': "재사용할 지시문",
  'settings.quickCommandsAdd': "명령 추가",
  'settings.quickCommandsSave': "변경 저장",
  'settings.quickCommandsCancelEdit': "편집 취소",
  'settings.quickCommandsReadError': "빠른 명령을 읽지 못했습니다.",
  'settings.quickCommandsSaveConflict': "다른 곳에서 목록이 바뀌었을 수 있습니다. 새로고침해 확인한 뒤 다시 저장하세요. 편집 중인 내용은 남아 있습니다.",
  'settings.quickCommandsCopyError': "명령을 복사하지 못했습니다.",
  'settings.quickCommandsTitleLabel': "빠른 명령 제목",
  'settings.quickCommandsTextLabel': "빠른 명령 지시문",
  ...
  'settings.tabKeyboard': '키보드',
  'settings.tabClaudeCode': 'Claude Code',
  'settings.tabOrchestrator': '오케스트레이터',
  'settings.tabRoles': '역할·팬아웃',
  'settings.tabRemote': '원격·휴대폰',
  'settings.tabLan': 'LAN',
  'settings.navGroupConnections': '연결',
  'settings.learnMore': '자세히',
  'settings.showLess': '간단히',
  'settings.quickCommands': '빠른 명령',
  'settings.sectionShell': '셸',
  'settings.sectionInput': '입력',
  'settings.sectionPerformance': '렌더링·메모리',
  'settings.sectionScrollback': '스크롤백',
  'settings.sectionInterface': '인터페이스',
  'settings.sectionSidebar': '사이드바',
  'settings.sectionPanes': '창',
  ...
  'deck.composerModeOffShort': 'Assist 모드를 켜고 대화를 시작하세요…',
  ...
  'settings.fanoutWorkerPermissionMode': '워커 권한 모드',
  'settings.fanoutWorkerPermissionModeDesc': '각 fan-out 워커가 실행될 Claude Code 권한 모드입니다. 어떤 모드에서도 워커는 확인 없이 원장 행을 기록하고 미션 채널을 읽을 수 있으며, fan-out·다른 창 입력·다른 에이전트에 메시지·브라우저 조작은 할 수 없습니다.',
  'settings.fanoutWorkerMode.auto': '자동 (권장)',
  'settings.fanoutWorkerMode.acceptEdits': '편집 허용',
  'settings.fanoutWorkerMode.bypassPermissions': '권한 우회',
  'settings.fanoutWorkerMode.manual': '수동 (모두 확인)',
  'settings.fanoutWorkerBypassWarning': '샌드박스 없음: 워커가 모든 도구를 묻지 않고 실행합니다.',
  'settings.fanoutAllowWorkerTools': 'Claude Code에 wmux 워커 도구 허용',
  'settings.fanoutAllowWorkerToolsDesc': '같은 최소 목록을 ~/.claude/settings.json의 permissions.allow에 추가합니다. 이 파일은 fan-out 워커뿐 아니라 이 컴퓨터의 모든 Claude Code 세션에 적용됩니다.',
  'settings.fanoutAllowWorkerToolsButton': '허용',
  'settings.fanoutAllowWorkerToolsDone': '{count}개 항목 추가됨',
  'settings.fanoutAllowWorkerToolsAlready': '이미 허용됨',
  'settings.fanoutAllowWorkerToolsFailed': 'settings.json을 수정하지 못했습니다: {error}',
  'settings.fanoutPresets': '팬아웃 프리셋',
  'settings.fanoutPresetsDesc': '오케스트레이터가 fanout_start({ preset: "<name>", titles, prompt })로 같은 프롬프트를 여러 에이전트 CLI에서 실행합니다. k번째 태스크는 k번째 행의 에이전트로 실행됩니다.',
  'settings.fanoutPresetsLoading': '프리셋을 불러오는 중…',
  'settings.fanoutPresetsLoadError': '프리셋을 읽지 못했습니다: {error}',
  'settings.fanoutPresetsEmpty': '아직 프리셋이 없습니다.',
  'settings.fanoutPresetsSaveError': '저장하지 못했습니다: {error}',
  'settings.fanoutPresetsInvalid': '저장할 수 없습니다: {error}',
  'settings.fanoutPresetsIssueRow': '{row}번째 행: {issue}',
  'settings.fanoutPresetsIssue.not-object': '프리셋을 읽을 수 있는 형식이 아닙니다.',
  'settings.fanoutPresetsIssue.unknown-field': '알 수 없는 항목 "{field}" (agent와 model만 받습니다).',
  'settings.fanoutPresetsIssue.agent-unknown': '알 수 없는 에이전트 "{agent}". 다음 중 하나를 쓰세요: {choices}.',
  'settings.fanoutPresetsIssue.agent-unavailable': '{agent}는 아직 fan-out에 쓸 수 없습니다 (처음부터 끝까지 검증되지 않음).',
  ...
  'settings.fanoutPresetsIssue.rows-over-cap': '"{name}"에 행이 {count}개 있습니다. 최대 {cap}개까지 가능합니다.',
  'settings.fanoutPresetsIssue.folder-invalid': '출력 폴더는 이름 하나여야 합니다: 영문자, 숫자, . _ -',
  'settings.fanoutPresetsIssue.folder-reserved': '"{folder}"은 Windows 예약 이름입니다.',
  'settings.fanoutPresetsIssue.duplicate-name': '"{name}" 이름의 프리셋이 이미 있습니다.',
  'settings.fanoutPresetsIssue.presets-not-array': '프리셋 목록을 읽을 수 있는 형식이 아닙니다.',
  'settings.fanoutPresetsIssue.presets-over-cap': '프리셋은 최대 {cap}개까지 가능합니다.',
  'settings.fanoutPresetsDisabled.unverified': '아직 처음부터 끝까지 검증되지 않음',
  'settings.fanoutPresetsDropped': '저장된 프리셋 {count}개를 불러오지 못해 표시하지 않았습니다. 여기서 저장하면 파일에서 사라지며, 이전 파일은 fanout-presets.json.bak으로 보관됩니다.',
  'settings.fanoutPresetsDroppedItem': '{name}: {issue}',
  'settings.fanoutPresetsUnreadable': '프리셋 파일을 읽을 수 없습니다. 여기서 저장하면 파일이 교체되며, 이전 파일은 fanout-presets.json.bak으로 보관됩니다.',
  'settings.fanoutPresetsAdd': '프리셋 추가',
  'settings.fanoutPresetsAddTemplate': '{name} 템플릿 추가',
  'settings.fanoutPresetsStorageWorktree': 'Git 워크트리',
  'settings.fanoutPresetsStorageOutputs': '워크트리 없음 → outputs/{folder}',
  'settings.fanoutPresetsEdit': '편집',
  'settings.fanoutPresetsDelete': '삭제',
  'settings.fanoutPresetsName': '이름',
  'settings.fanoutPresetsNameDesc': '오케스트레이터가 preset에 넘기는 값입니다. 영문자, 숫자, 공백 . _ -',
  'settings.fanoutPresetsDescription': '설명',
  'settings.fanoutPresetsDescriptionPlaceholder': '선택 사항',
  'settings.fanoutPresetsAgents': '에이전트',
  'settings.fanoutPresetsAgentsDesc': 'k번째 태스크는 k번째 행에서 실행됩니다. 태스크가 행보다 많은 팬아웃은 거부됩니다.',
  'settings.fanoutPresetsAgentLabel': '에이전트 {index}',
  'settings.fanoutPresetsAgentUnavailable': '{label} (사용 불가: {reason})',
  'settings.fanoutPresetsModelLabel': '에이전트 {index} 모델',
  'settings.fanoutPresetsModelPlaceholder': '기본 모델',
  'settings.fanoutPresetsModelUnsupported': '검증된 모델 플래그 없음',
  'settings.fanoutPresetsUnattended': '무인 실행',
  'settings.fanoutPresetsUnattendedLabel': '에이전트 {index} 무인 실행',
  'settings.fanoutPresetsUnattendedWarning': '{cli} 실행 옵션 {flags}: 승인 확인이 뜨지 않습니다. claude 전용 워커 도구 차단 목록(--disallowedTools)은 이 CLI에 적용되지 않습니다.',
  'settings.fanoutPresetsRemoveRow': '에이전트 {index} 삭제',
  'settings.fanoutPresetsAddAgent': '에이전트 추가',
  'settings.fanoutPresetsWorktree': 'Git 워크트리',
  'settings.fanoutPresetsWorktreeDesc': '켜기: 태스크마다 저장소의 워크트리를 따로 만듭니다. 끄기: 태스크마다 outputs/ 아래에 폴더를 따로 만듭니다.',
  'settings.fanoutPresetsOutputFolder': '출력 폴더',
  'settings.fanoutPresetsOutputPath': '태스크 결과는 {path}에 저장됩니다',
  'settings.fanoutPresetsSave': '저장',
  'settings.fanoutPresetsCancel': '취소',
  ...
  'settings.browserSectionRuntime': '브라우저 실행',
  'settings.browserSectionKnowledge': '에이전트 사이트 지식',
  'settings.siteGuides': '사이트 가이드',
  'settings.siteGuidesDesc': '브라우저가 wmux 데이터 폴더의 site-guides 폴더에 있는 노트와 일치하는 페이지에 도착하면, 그런 노트가 있고 어디에 있는지 에이전트에게 알려줍니다. 제목과 경로만 전달하고 노트 내용은 전달하지 않습니다. 브라우저 읽기 권한이 있는 도구는 어떤 URL에 맞는 노트가 있는지 물어 제목과 경로를 알 수 있지만, 내용은 알 수 없습니다. 기본값은 꺼짐입니다. Chrome 에이전트 브라우저를 처음 선택하면 자동으로 켜지고, 그 뒤로는 사용자가 정한 대로 유지됩니다.',
  ...
  'settings.chromePresetDesc': '미니멀은 사이드바를 접고 에이전트 툴바·패널 조작·도구 패널을 숨깁니다. 적용된 표시 설정은 저장되며, 개별 변경하거나 표준으로 복원할 수 있습니다.',
  ...
  'settings.sidebarSortDesc': '사이드바가 워크스페이스를 나열하는 방식입니다. 주의(기본)는 응답이 필요한 것을 먼저, 이어서 끝남·실행 중·확인 불가·유휴 순으로 둡니다. 고정한 행은 자리를 지키고, 목록은 잠깐 멈춘 뒤나 포인터가 벗어났을 때만 다시 정렬됩니다. 수동은 드래그한 순서를 유지합니다. 드래그 정렬은 수동에서만 됩니다.',
  'settings.sidebarSortManual': '수동',
  'settings.sidebarSortAttention': '주의',
  'settings.sidebarSortRecent': '최근 활동',
  ...
  'settings.chatView': '여러 에이전트 챗뷰 (실험적)',
  'settings.chatViewDesc': 'Claude 대화 기록과 별도 Codex·OpenCode·설정된 ACP 챗 세션을 위한 터미널 / 챗 전환을 표시합니다. 프로덕션 검증 중이며 기본값은 꺼짐입니다.',
  ...
  'settings.sc.jumpWorkspace': '작업공간 {n}(으)로 전환',
  'settings.sc.lastWorkspace': '마지막 작업공간으로 전환',
  'settings.sc.closeWorkspace': '작업공간 닫기',
  'settings.sc.jumpToUnread': '가장 최근 읽지 않은 알림으로 이동',
  'settings.sc.nextSurface': '다음 탭',
  'settings.sc.prevSurface': '이전 탭',
  'settings.sc.nextPane': '다음 창',
  'settings.sc.prevPane': '이전 창',
  'settings.sc.focusUp': '위로 포커스 이동',
  'settings.sc.focusDown': '아래로 포커스 이동',
  'settings.sc.focusLeft': '왼쪽으로 포커스 이동',
  'settings.sc.focusRight': '오른쪽으로 포커스 이동',
  'settings.sc.focusUpAlt': '위 창으로 포커스 (보조)',
  'settings.sc.focusDownAlt': '아래 창으로 포커스 (보조)',
  'settings.sc.focusLeftAlt': '왼쪽 창으로 포커스 (보조)',
  'settings.sc.focusRightAlt': '오른쪽 창으로 포커스 (보조)',
  'settings.sc.openSettings': '설정 열기',
  'settings.sc.toggleFleetView': 'Fleet View 전환',
  'settings.sc.toggleCompanyView': 'Company View 전환',
  'settings.sc.clearMultiview': '단일 보기로 돌아가기',
  'settings.sc.openBrowser': '브라우저 창 열기',
  'settings.sc.addBookmark': '스크롤 위치 북마크',
  'settings.sc.toggleMessageFeed': '메시지 피드 전환',
  'settings.sc.zoomIn': '글꼴 크게',
  'settings.sc.zoomOut': '글꼴 작게',
  'settings.sc.zoomReset': '글꼴 크기 초기화',
  'settings.sc.mentionAgent': '에이전트 멘션',
  'mention.title': '에이전트 멘션',
  'mention.placeholder': '멘션할 에이전트…',
  'mention.empty': '실행 중인 다른 에이전트가 없습니다',
  'mention.noMatch': '일치하는 에이전트가 없습니다',
  'mention.workspaceRow': '워크스페이스 · 에이전트 {count}개',
  'mention.insert': '참조 삽입',
  'mention.sendHint': '메시지 전송',
  'mention.send': '보내기',
  'mention.messageLabel': '바로 보낼 메시지',
  'mention.messagePlaceholder': '{name}에게 보낼 메시지',
  'mention.needMessage': '메시지를 입력한 뒤 {combo}',
  'mention.sent': '{name}에게 보냄',
  'mention.sentNudge': '{name}에게 보냄 · 한 줄 알림으로 전달',
  'mention.stored': '저장됨, {name}에게 전달되지 않음: {reason}',
  'mention.refused': '거부됨: {reason}',
  'mention.noSource': '에이전트 판에 포커스를 두고 다시 시도하세요',
  'mention.button': '포커스된 에이전트에 {name} 멘션',
  'mention.pickPane': '메시지를 보내려면 판을 고르세요',
  'mention.noComposer': '대화 입력창이 아직 준비되지 않았습니다. 잠시 후 다시 시도하세요',
  'mention.composerFull': '메시지에 멘션을 넣을 자리가 없습니다. 먼저 줄여 주세요',
  'mention.paneGone': '판이 닫혀 아무것도 넣지 않았습니다',
  ...
  'settings.sc.needsModifier': 'Ctrl, ⌘, Alt 중 하나를 함께 누르세요 (F키는 단독 가능)',
  'settings.sc.reservedKey': '{combo}는 복사·붙여넣기용으로 예약됨',
  'settings.sc.prefixConflict': '{combo}는 프리픽스 키입니다',
  ...
  'onboarding.step1.title': '모든 에이전트를 한눈에',
  'onboarding.step1.description': '에이전트가 입력을 기다리면 사이드바에 바로 표시됩니다. Fleet을 열면 모든 에이전트를 한 화면에서, 기다리는 것부터 볼 수 있습니다.',
  'onboarding.step2.title': '병렬로 나눠 맡기기',
  'onboarding.step2.description': '프롬프트 하나를 여러 에이전트에게 나눠 주세요. 작업마다 자체 git 워크트리와 wtask/ 브랜치에서 실행되고, 시작한 워크스페이스 아래에 표시됩니다.',
  ...
  'channels.taskCommentPlaceholder': '작업에 의견 남기기…',
  'channels.readFullUpdate': '전체 내용 보기',
  'channels.taskRecord': '작업 기록',
  'channels.taskOpen': '열림',
  'channels.taskClosed': '닫힘',
  'channels.taskDetached': '분리됨',
  'channels.openTaskWorkspace': '작업공간 열기 →',
  'channels.latestActivity': '최근 활동',
  'channels.noActivity': '아직 기록된 활동이 없습니다.',
  'channels.showActivity': '논의와 활동 기록 보기',
  'channels.hideActivity': '논의와 활동 기록 접기',
  'channels.discussionPurpose': '결정과 맥락을 공유하는 공간입니다. 작업은 A2A로 위임하거나 특정 에이전트를 멘션하세요.',
  'channels.recordOnlyHint': '공유 기록에 남깁니다. 응답이 필요하면 @로 에이전트를 선택하세요.',
  'channels.taskRecords': '작업 기록',
  'channels.discussions': '공유 논의',
  'channels.title': '채널',
  ...
  'deck.panelLabel': '도구 패널',
  'deck.collapseDock': '도구 패널 닫기',
  ...
  'deck.recoveryTitle': '에이전트 세션 {count}개를 복구할 수 있습니다.',
