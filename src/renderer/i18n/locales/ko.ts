export const ko = {
  ...
  'settings.fanoutWorkerPermissionModeDesc': 'fan-out 워커가 실행될 Claude Code 권한 모드입니다. 워커에는 최소한의 wmux 도구 허용 목록(태스크 원장, 미션 채널, whoami)도 함께 주어집니다.',
  ...
  'settings.fanoutAllowWorkerToolsDesc': '같은 최소 목록을 ~/.claude/settings.json의 permissions.allow에 추가해, 워커의 보고 호출이 확인창에서 멈추지 않게 합니다.',
