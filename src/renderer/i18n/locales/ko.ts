export const ko = {
  ...
  'chat.reason.no-hook': "이 터미널에서 Claude Code를 실행하면 대화 기록을 볼 수 있습니다.",
  'chat.reason.stale-session': "Claude가 실행 중이지만 대화 기록이 아직 연결되지 않았습니다. 터미널에서 계속 작업하면 자동으로 다시 확인합니다.",
  'chat.reason.no-transcript-path': "Claude의 대화 기록 파일을 기다리고 있습니다.",
  'chat.reason.not-claude': "현재 챗뷰는 Claude Code 세션을 지원합니다. 이 에이전트는 터미널에서 사용해 주세요.",
  ...
  'chat.emptyHint': "이 Claude 세션의 메시지가 여기에 표시됩니다.",
  'chat.working': "Claude가 작업 중입니다…",
  ...
  'chat.placeholder': "이 Claude 세션에 메시지 보내기…",
