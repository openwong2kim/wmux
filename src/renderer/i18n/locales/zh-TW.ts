export const zhTW = {
  ...
  'update.readyToInstall': 'wmux {version} 已可安裝。目前執行的是 {current}。安裝將關閉所有正在執行的工作階段。',
  ...
  'sessionSchedule.hint': 'wmux 會等到這個 agent 可接收新任務，再安全貼上並送出提示。到期提示可跨 app 重啟保留，並在 wmux 與此 session 可用時執行。',
  ...
  'sessionSchedule.statusBusy': '等待閒置',
