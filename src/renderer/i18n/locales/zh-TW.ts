export const zhTW = {
  ...
  'settings.tabKeyboard': "鍵盤",
  'settings.tabClaudeCode': "Claude Code",
  'settings.tabOrchestrator': "協調器",
  'settings.tabRoles': "角色與扇出",
  'settings.tabRemote': "遠端與手機",
  'settings.tabLan': "區域網路",
  'settings.navGroupConnections': "連線",
  'settings.learnMore': "了解更多",
  'settings.showLess': "收合",
  'settings.quickCommands': "快速指令",
  'settings.sectionShell': "Shell",
  'settings.sectionInput': "輸入",
  'settings.sectionPerformance': "轉譯與記憶體",
  'settings.sectionScrollback': "回捲",
  'settings.sectionInterface': "介面",
  'settings.sectionSidebar': "側邊欄",
  'settings.sectionPanes': "窗格",
  'settings.quickCommandsDesc': "與此 Mac 配對的手機共用。複製或插入指令，傳送前請檢查。",
  'settings.quickCommandsRefresh': "重新整理",
  'settings.quickCommandsCopy': "複製",
  'settings.quickCommandsCopied': "已複製",
  'settings.quickCommandsEdit': "編輯",
  'settings.quickCommandsDelete': "刪除",
  'settings.quickCommandsTitlePlaceholder': "標題",
  'settings.quickCommandsTextPlaceholder': "可重複使用的指令",
  'settings.quickCommandsAdd': "新增指令",
  'settings.quickCommandsSave': "儲存變更",
  'settings.quickCommandsCancelEdit': "取消編輯",
  'settings.quickCommandsReadError': "無法讀取快速指令。",
  'settings.quickCommandsSaveConflict': "清單可能已在別處變更。請重新整理並檢查後再儲存。編輯器中的文字會保留。",
  'settings.quickCommandsCopyError': "無法複製該指令。",
  'settings.quickCommandsTitleLabel': "快速指令標題",
  'settings.quickCommandsTextLabel': "快速指令內容",
  ...
  'settings.sidebarAttentionFirst': '需要你的列排在最前',
  'settings.sidebarAttentionFirstDesc': '將代理正在等待你回應的工作區移到側邊欄頂部。預設關閉：列會留在你拖曳的位置。 開啟期間，拖曳排序會暫停。',
  'settings.sidebarShowPaneCoordinates': '顯示窗格座標',
  'settings.sidebarShowPaneCoordinatesDesc': '為未命名的窗格在代理清單中顯示自動產生的 w1-2 形式座標。預設開啟。已重新命名的窗格無論此設定為何都一律顯示其名稱。',
