export const en = {
  ...
  'sessionSchedule.hint': 'wmux waits until this agent is ready, then safely pastes and submits the prompt. Due prompts survive app restarts and run when wmux and this session are available.',
  ...
  'sessionSchedule.statusBusy': 'waiting for idle',
