export const en = {
  ...
  'settings.sidebarSortDesc': 'How the sidebar lists workspaces. Manual keeps the order you dragged. The other two only change what you see, and pause drag-to-reorder while on.',
  'settings.sidebarSortManual': 'Manual',
  'settings.sidebarSortAttention': 'Needs you first',
