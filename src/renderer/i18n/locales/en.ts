export const en = {
  ...
  'chat.reason.not-claude': "Chat currently supports Claude Code sessions. Use Terminal for this agent.",
  ...
  'chat.emptyHint': "Messages from this Claude session will appear here.",
