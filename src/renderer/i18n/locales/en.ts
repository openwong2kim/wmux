export const en = {
  ...
  'settings.fanoutWorkerPermissionModeDesc': 'The Claude Code permission mode each fan-out worker launches with. Workers also get a minimal wmux tool allow-list (task ledger, mission channel, who-am-I).',
  ...
  'settings.fanoutAllowWorkerToolsDesc': 'Adds the same minimal list to permissions.allow in ~/.claude/settings.json, so a worker\'s report-back calls never stop on a prompt.',
