export const en = {
  ...
  'chat.reason.no-hook': "Start Claude Code in this terminal to see its conversation here.",
  'chat.reason.stale-session': "Claude is running, but its conversation is not linked yet. Keep working in Terminal; this view checks again automatically.",
  'chat.reason.no-transcript-path': "Waiting for Claude to create its conversation file.",
