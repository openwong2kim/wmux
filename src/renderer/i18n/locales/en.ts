export const en = {
  ...
  'settings.chatKeepWarm': 'Unload terminals behind Chat View',
  'settings.chatKeepWarmDesc': 'Default off. A pane showing Chat View keeps its terminal loaded behind the conversation, so switching back to the terminal is instant. Turn on to keep only the last few chat panes loaded and unload the rest, which frees memory when many panes are in Chat View; the sessions keep running in the daemon, and switching one of those panes back to its terminal replays the screen first, which can take a moment on a busy pane.',
  ...
  // ─── Chat View: the supervision lens over a pane's transcript ────────────
  'chat.you': 'You',
  'chat.agent': 'Agent',
  'chat.empty': 'No turns yet.',
  'chat.loadEarlier': 'Load earlier',
  'chat.placeholder': 'Message this agent… Enter sends, Shift+Enter or Ctrl+J for a new line',
  'chat.sending': 'sending…',
  'chat.answerInTerminal': 'Answer in terminal →',
  'chat.terminalOnlyAnswer': 'This pane is waiting on a terminal-only answer.',
  'chat.status.running': 'running',
  'chat.status.idle': 'idle',
  'chat.status.complete': 'complete',
  'chat.status.needsInput': 'needs you',
  'chat.toolRun': '1 tool call',
  'chat.toolRuns': '{count} tool calls',
  'chat.toolRunMore': '+{count} more',
  'chat.expandToolRun': 'Expand tool calls',
  'chat.toolInput': 'called with',
  'chat.toolOutput': 'returned',
  'chat.showFullBody': 'show all {bytes} bytes',
  'chat.loadingBody': 'loading…',
  'chat.bodyUnavailable': 'no longer available',
  ...
  'chat.codeError': "couldn't load this block",
  'chat.retry': 'Retry',
  'chat.diffChip': 'diff · {bytes} B',
  'chat.openDiff': 'Open in the diff surface',
  'chat.trustSeam': 'projection of {basename} · terminal is ground truth',
  'chat.trustSeamNoFile': 'projection of this pane · terminal is ground truth',
  'chat.trustSeamStale': 'projection may lag the terminal · terminal is ground truth',
  'chat.jumpToTerminal': 'Jump to the terminal',
  ...
  'chat.menu.showChat': 'Show as chat',
  'chat.menu.showTerminal': 'Show as terminal',
