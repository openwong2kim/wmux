export const ja = {
  ...
  'settings.tabKeyboard': "キーボード",
  'settings.tabClaudeCode': "Claude Code",
  'settings.tabOrchestrator': "オーケストレーター",
  'settings.tabRoles': "ロールとファンアウト",
  'settings.tabRemote': "リモートとスマホ",
  'settings.tabLan': "LAN",
  'settings.navGroupConnections': "接続",
  'settings.learnMore': "詳しく",
  'settings.showLess': "閉じる",
  'settings.quickCommands': "クイックコマンド",
  'settings.sectionShell': "シェル",
  'settings.sectionInput': "入力",
  'settings.sectionPerformance': "描画とメモリ",
  'settings.sectionScrollback': "スクロールバック",
  'settings.sectionInterface': "インターフェース",
  'settings.sectionSidebar': "サイドバー",
  'settings.sectionPanes': "ペイン",
  'settings.quickCommandsDesc': "この Mac とペアリングしたスマホと共有します。指示をコピーまたは挿入し、送信前に確認してください。",
  'settings.quickCommandsRefresh': "再読み込み",
  'settings.quickCommandsCopy': "コピー",
  'settings.quickCommandsCopied': "コピー済み",
  'settings.quickCommandsEdit': "編集",
  'settings.quickCommandsDelete': "削除",
  'settings.quickCommandsTitlePlaceholder': "タイトル",
  'settings.quickCommandsTextPlaceholder': "再利用する指示",
  'settings.quickCommandsAdd': "コマンドを追加",
  'settings.quickCommandsSave': "変更を保存",
  'settings.quickCommandsCancelEdit': "編集をキャンセル",
  'settings.quickCommandsReadError': "クイックコマンドを読み込めませんでした。",
  'settings.quickCommandsSaveConflict': "一覧が別の場所で変更された可能性があります。再読み込みして確認してから保存してください。編集中のテキストは残ります。",
  'settings.quickCommandsCopyError': "コマンドをコピーできませんでした。",
  'settings.quickCommandsTitleLabel': "クイックコマンドのタイトル",
  'settings.quickCommandsTextLabel': "クイックコマンドの指示",
  ...
  'settings.chromePreset': 'インターフェースの表示',
  'settings.chromePresetDesc': '1 回限りのレイアウトプリセットを適用します。個別の表示設定は引き続き編集でき、モードは保存されません。',
  'settings.chromePresetMinimal': 'ミニマルを適用',
  'settings.chromePresetStandard': '標準に戻す',
  'settings.chromePresetApplied': 'インターフェースの表示を更新しました。',
  ...
  'settings.sidebarAttentionFirstDesc': 'エージェントがあなたの応答を待っているワークスペースをサイドバーの最上部に移動します。既定はオフ：行はドラッグした位置のままです。 オンの間、ドラッグでの並べ替えは停止します。',
  ...
  'settings.updateEndsSessions': 'インストールするとすべてのペインが閉じられます。',
  'settings.currentVersion': '現在',
  'settings.latestVersion': '最新',
  'update.readyToInstall': 'wmux {version} をインストールできます。現在 {current} を使用中です。インストールするとすべてのペインが閉じられます。',
  'update.installNow': '今すぐインストール',
  'update.installFailed': 'アップデートをインストールできませんでした。{error}',
