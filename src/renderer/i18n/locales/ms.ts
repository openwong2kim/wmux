export const ms = {
  ...
  'settings.tabKeyboard': "Papan kekunci",
  'settings.tabClaudeCode': "Claude Code",
  'settings.tabOrchestrator': "Pengorkestra",
  'settings.tabRoles': "Peranan & fan-out",
  'settings.tabRemote': "Jauh & telefon",
  'settings.tabLan': "LAN",
  'settings.navGroupConnections': "Sambungan",
  'settings.learnMore': "Ketahui lagi",
  'settings.showLess': "Tunjuk kurang",
  'settings.quickCommands': "Arahan pantas",
  'settings.sectionShell': "Shell",
  'settings.sectionInput': "Input",
  'settings.sectionPerformance': "Pemaparan dan memori",
  'settings.sectionScrollback': "Sejarah tatal",
  'settings.sectionInterface': "Antara muka",
  'settings.sectionSidebar': "Bar sisi",
  'settings.sectionPanes': "Anak tetingkap",
  'settings.quickCommandsDesc': "Dikongsi dengan telefon yang dipasangkan pada Mac ini. Salin atau sisipkan arahan, kemudian semak sebelum menghantar.",
  'settings.quickCommandsRefresh': "Muat semula",
  'settings.quickCommandsCopy': "Salin",
  'settings.quickCommandsCopied': "Disalin",
  'settings.quickCommandsEdit': "Edit",
  'settings.quickCommandsDelete': "Padam",
  'settings.quickCommandsTitlePlaceholder': "Tajuk",
  'settings.quickCommandsTextPlaceholder': "Arahan boleh guna semula",
  'settings.quickCommandsAdd': "Tambah arahan",
  'settings.quickCommandsSave': "Simpan perubahan",
  'settings.quickCommandsCancelEdit': "Batal edit",
  'settings.quickCommandsReadError': "Tidak dapat membaca arahan pantas.",
  'settings.quickCommandsSaveConflict': "Senarai mungkin telah berubah di tempat lain. Muat semula dan semak sebelum menyimpan semula. Teks editor anda dikekalkan.",
  'settings.quickCommandsCopyError': "Tidak dapat menyalin arahan.",
  'settings.quickCommandsTitleLabel': "Tajuk arahan pantas",
  'settings.quickCommandsTextLabel': "Kandungan arahan pantas",
  ...
  'settings.chromePreset': 'Keterlihatan antara muka',
  'settings.chromePresetDesc': 'Gunakan pratetap susun atur sekali sahaja. Kawalan keterlihatan individu kekal boleh diedit; tiada mod disimpan.',
  'settings.chromePresetMinimal': 'Gunakan Minimal',
  'settings.chromePresetStandard': 'Pulihkan Standard',
  'settings.chromePresetApplied': 'Keterlihatan antara muka telah dikemas kini.',
  ...
  'settings.currentVersion': 'Semasa',
  'settings.latestVersion': 'Terkini',
  'update.readyToInstall': 'wmux {version} sedia dipasang. Anda menjalankan {current}. Pemasangan akan menutup semua panel.',
  'update.installNow': 'Pasang sekarang',
  'update.installFailed': 'Kemas kini tidak dapat dipasang. {error}',
