          ...
          return (
            <div key={ws.id} className="relative w-8">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span
                    className="absolute -top-0.5 -right-0.5 bg-[var(--bg-surface)] text-[var(--text-main)] text-[10px] font-bold rounded-full min-w-[12px] h-3 flex items-center justify-center px-0.5 leading-none ring-1 ring-[var(--border-soft)]"
